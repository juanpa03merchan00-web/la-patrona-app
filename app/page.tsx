...
export default function Home() {
  ...
  return (
    // EL "max-w-md mx-auto" hace que en PC se vea como un celular centrado
    <main className="min-h-screen bg-black text-white max-w-md mx-auto border-x border-zinc-900 shadow-2xl pb-80">
      ...
      {/* FOOTER FIJO - Centrado con el resto de la app */}
